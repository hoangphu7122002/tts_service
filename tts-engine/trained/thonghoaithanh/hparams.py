...
hparams = tf.contrib.training.HParams(
    data='data/thonghoaithanh-16k',  # required
    version='v1-20191024',  # default=v.DDMM
    ...
    phone_vn_train='trained/dicts/phone_vn_south',  # required for phone embedding
    phone_oov_train='',
    eos='',
    punctuation='~,.*',
    special='-',
    ...
    sampling_rate=16000,
    filter_length=1024,
    hop_length=200,  # for 22k: 256, for 16k: 200
    win_length=800,  # for 22k: 1024, for 16k: 800
    n_mel_channels=80,
