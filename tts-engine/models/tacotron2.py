...
from utils.text_utils import symbols2numeric
...
class Tacotron2(nn.Module):
    def __init__(self, hparams):
        ...
        self.n_mel_channels = hparams.n_mel_channels
        self.n_frames_per_step = hparams.n_frames_per_step
        self.symbols = symbols2numeric(hparams)
        self.embedding = nn.Embedding(
            len(self.symbols), hparams.symbols_embedding_dim)
        std = sqrt(2.0 / (len(self.symbols) + hparams.symbols_embedding_dim))
